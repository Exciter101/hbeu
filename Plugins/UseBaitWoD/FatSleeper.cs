...
namespace Use_Bait___Fat_Sleeper_Bait
{
    public class Fat_Sleeper_Bait : HBPlugin
    {
        #region Globals

        public override string Name { get { return "Bait - Fat Sleeper Bait - Nagrand"; } }
        ...
        public WoWItem FatSleeperBait()
        {
            return FindFirstUsableItemBySpell("Fat Sleeper Bait");
        }
        ...
        public override void Pulse()
        {
            ...
            {
                if (!Me.HasAura("Fat Sleeper Bait"))
                {
                    WoWItem gPoL = FatSleeperBait();
                    if (gPoL != null)
                    {
