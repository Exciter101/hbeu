...
namespace Use_Bait___Blackwater_Whiptail_Bait
{
    public class Blackwater_Whiptail_Bait : HBPlugin
    {
        #region Globals

        public override string Name { get { return "Bait - Blackwater Whiptail Bait - Talador"; } }
        ...
        public WoWItem BlackwaterWhiptailBait()
        {
            return FindFirstUsableItemBySpell("Blackwater Whiptail Bait");
        }
        ...
        public override void Pulse()
        {
            ...
            {
                if (!Me.HasAura("Blackwater Whiptail Bait"))
                {
                    WoWItem gPoL = BlackwaterWhiptailBait();
                    if (gPoL != null)
                    {
