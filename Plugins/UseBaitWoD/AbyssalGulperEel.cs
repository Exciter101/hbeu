...
namespace Use_Bait___Abyssal_Gulper_Eel_Bait
{
    public class Abyssal_Gulper_Eel_Bait : HBPlugin
    {
        #region Globals

        public override string Name { get { return "Bait - Abyssal Gulper Eel Bait - Spires of Arrak"; } }
        ...
        public WoWItem AbyssalGulperEelBait()
        {
            return FindFirstUsableItemBySpell("Abyssal Gulper Eel Bait");
        }
        ...
        public override void Pulse()
        {
            ...
            {
                if (!Me.HasAura("Abyssal Gulper Eel Bait"))
                {
                    WoWItem gPoL = AbyssalGulperEelBait();
                    if (gPoL != null)
                    {
