...
namespace Use_Bait___Jawless_Skulker_Bait
{
    public class Jawless_Skulker_Bait : HBPlugin
    {
        #region Globals

        public override string Name { get { return "Bait - Jawless Skulker Bait - Gorgrond"; } }
        ...
        public WoWItem JawlessSkulkerBait()
        {
            return FindFirstUsableItemBySpell("Jawless Skulker Bait");
        }
        ...
        public override void Pulse()
        {
            ...
            {
                if (!Me.HasAura("Jawless Skulker Bait"))
                {
                    WoWItem gPoL = JawlessSkulkerBait();
                    if (gPoL != null)
                    {
