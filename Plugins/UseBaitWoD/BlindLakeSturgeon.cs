...
namespace Use_Bait___Blind_Lake_Sturgeon_Bait
{
    public class Blind_Lake_Sturgeon_Bait : HBPlugin
    {
        #region Globals

        public override string Name { get { return "Bait - Blind Lake Sturgeon Bait - Shadowmoon"; } }
        ...
        {
            return FindFirstUsableItemBySpell("Blind Lake Sturgeon Bait");
        }
        ...
        public override void Pulse()
        {
            ...
            {
                if (!Me.HasAura("Blind Lake Sturgeon Bait"))
                {
