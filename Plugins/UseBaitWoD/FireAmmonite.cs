...
namespace Use_Bait___Fire_Ammonite_Bait
{
    public class Fire_Ammonite_Bait : HBPlugin
    {
        #region Globals

        public override string Name { get { return "Bait - Fire Ammonite Bait"; } }
        ...
        {
            return FindFirstUsableItemBySpell("Fire Ammonite Bait");
        }
        ...
        public override void Pulse()
        {
            ...
            {
                if (!Me.HasAura("Fire Ammonite Bait"))
                {
