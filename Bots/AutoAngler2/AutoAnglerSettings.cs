...
namespace HighVoltz.AutoAngler
{
	public class AutoAnglerSettings : Settings
	{
        ...
        Description("So Abyssal! Much Gulper!"), Category("Baits")]
        public bool AbyssalGulperEelBait { get; set; }

        [Setting, Styx.Helpers.DefaultValue(true),
                Description("We dont need no water let the..."), Category("Baits")]
        public bool FireAmmoniteBait { get; set; }

        [Setting, Styx.Helpers.DefaultValue(true),
                Description("Zatoichi!"), Category("Baits")]
        public bool BlindLakeSturgeonBait { get; set; }

        [Setting, Styx.Helpers.DefaultValue(true),
                Description("Sub-Zero nemesis"), Category("Baits")]
        public bool SeaScorpionBait { get; set; }

        [Setting, Styx.Helpers.DefaultValue(true),
                Description("No comments"), Category("Baits")]
        public bool JawlessSkulkerBait { get; set; }

        [Setting, Styx.Helpers.DefaultValue(true),
                Description("Your Sleeper so fat..."), Category("Baits")]
        public bool FatSleeperBait { get; set; }

        [Setting, Styx.Helpers.DefaultValue(true),
                Description("Blackwater bay need more cg!"), Category("Baits")]
        public bool BlackwaterWhiptailBait { get; set; }

        [Setting, Styx.Helpers.DefaultValue(true),
                Description("Icespine?"), Category("Baits")]
        public bool IcespineStingerBait { get; set; }

        [Setting, Styx.Helpers.DefaultValue(true),
                Description("Moonshell? Really?"), Category("Baits")]
        public bool MoonshellClawBait { get; set; }            
        ...
        [Setting, Styx.Helpers.DefaultValue(true),
                Description("Should i use it? It`s not always work as intended."), Category("CarpMinnow")]
        public bool KaarpHuyarp { get; set; }

        [Setting, Styx.Helpers.DefaultValue(10),
        Description(
            "Combat delay in seconds after using Carp/Minnow. Without delay it`ll be killed in water and usally cant be looted."), Category("CarpMinnow")]
        public int KaarpDelay { get; set; }
